...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'fred' => [
            'driver' => 'mysql',
            'host' => env('DB_FRED_HOST', '127.0.0.1'),
            'port' => env('DB_FRED_PORT', '3306'),
            'database' => env('DB_FRED_DATABASE', 'forge'),
            'username' => env('DB_FRED_USERNAME', 'forge'),
            'password' => env('DB_FRED_PASSWORD', ''),
            'charset' => 'utf8mb4',
